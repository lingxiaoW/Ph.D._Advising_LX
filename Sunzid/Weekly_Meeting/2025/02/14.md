...
* **Steps**:
  ...
  * **Zero-shot LLM-based Navigation**
    * **Overview:**
      ...
      * [ ] Plume plot should be more broad to reflect robot olfactory detection.
      * [ ] Try to add wind. For source 1, wind direction is +z. For source 2, wind direction is +x. Wind speed is a reasonable number (0-1,2).
      * [ ] Record:
        * [ ] GPT reasoning
        * [ ] Count of decision making steps and derive travelling distance.
