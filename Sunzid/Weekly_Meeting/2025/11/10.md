...
* [ ] Methodology
  * [ ] Use the oneStep control algorithms.
  * [ ] Check the difference between min-max and divide by sum. Then change all normalization to min-max [0-1] range.
 ...
 * [ ] Start writing the Experiment Section on the paper draft
   * [ ] Delete the olfactory only and rw figures. Make the trajectory figure larger and delete initial 3 frames out of the 4. Pick critical points and show the entropy maps.
   * [ ] Add object names in critical points in visual entropy maps.
