...
10-30: wrote a new model that uses both geometry and input data to predict output, wrote two more model variations - one with convolutional neural networks, another with transformers.  
