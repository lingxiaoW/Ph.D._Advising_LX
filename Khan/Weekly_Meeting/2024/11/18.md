...
* **Task**
  ...
  * Worked on graph embedding and time series prediction. Tried to predict moving average stress. It does not give good prediction.
  
    RMSE: 0.7236, MAPE: 48.94%, Pearson Correlation: 0.1006.

  - prediction Plot: 
        <p align="center">
        <img src="./../../../images/graph-embedding-time-series.png" width="70%">
        </p>
