    ...
    * 10-18 update:
    cycleGAN results
      ...
      * New simulated U ( record u and v where con > 0 else u and v = 0)
       ...
       <p align="center">
        <img src="./../../../images/44-sim.png" width="48%">
        <img src="./../../../images/45-sim.png" width="48%">
      </p>

      * Sim to real U ( with New simulated U and cycleGAN con model )

       <p align="center">
        <img src="./../../../images/44.png" width="48%">
        <img src="./../../../images/45.png" width="48%">
      </p>

      * New simulated V ( record u and v where con > 0 else u and v = 0)

       <p align="center">
        <img src="./../../../images/44-sim-v.png" width="48%">
        <img src="./../../../images/45-sim-v.png" width="48%">
      </p>
