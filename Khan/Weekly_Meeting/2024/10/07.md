...
* [ ] ~~DDPG Application (middle priority)~~
  ...
  * 10-10 update: Start working on transformer from tomorrow. I converted my cycleGAN code from COlab to pycharm version. Now checking the pycharm version if it correctly runs. 
