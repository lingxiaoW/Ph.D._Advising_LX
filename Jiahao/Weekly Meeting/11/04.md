...
* **Paper Writing**: 3D Odor Source Localization.
  * **Tasks**:
    ...
    * **Dimension Match:**
      * Drone simulation env: x: -3 to 3, y: -3 to 3, z: to . Resolution:
      * Plume Simulation env: x: -300 to 300, y: to , z: to . Resolution: 
      * Unify them: x:  , y: , z: 

    * [ ] **File 1: Sensor Reading**:
    ...
    * [ ] **File 3: Navigation Controller (Plume Tracing Control Algorithm)**: 
       ``` 
        If con > threshold:
