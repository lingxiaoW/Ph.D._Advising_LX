...
* **Paper Writing**: 3D Odor Source Localization.
  * **Tasks**:
    * Pesudo Code:
    ...
    ```
    * **Sensor Reading**:
      * Get the gas concentration and wind speed/direction at robot location.
    
    * **Get Drone Status**:
      * Get the drone location, heading, speed, etc.

    * **Navigation Controller (Plume Tracing Control Algorithm)**: 
       ``` 
        If con > threshold:
